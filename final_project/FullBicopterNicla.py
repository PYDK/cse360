...
if __name__ == "__main__":
    ...
    # nicla parameters
    serial.send_preference(ROBOT_MAC, DataType_Float, "y_thresh", 0.4) 
    serial.send_preference(ROBOT_MAC, DataType_Float, "y_strength", 1.75) #1.5
    serial.send_preference(ROBOT_MAC, DataType_Float, "x_strength", 1.5)

    serial.send_preference(ROBOT_MAC, DataType_Float, "fx_togoal", 0.1) #0.2
    serial.send_preference(ROBOT_MAC, DataType_Float, "fx_charge", 0.5) #0.7
    serial.send_preference(ROBOT_MAC, DataType_Float, "fx_levy", 0) # 0.15
